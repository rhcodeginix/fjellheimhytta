...
import { convertCurrencyFormat } from "./plotProperty";
      ...
      <div className="sticky top-[86px] bg-lightBlue rounded-[12px]">
        ...
        <div className="p-4 laptop:px-6 laptop:py-5 h-auto max-h-[600px] overflow-y-auto overFlowYAuto overflow-x-hidden">
          ...
          >
            ...
            <div>
              <button
                className={`p-1.5 lg:p-[10px] cursor-pointer flex justify-center items-center bg-primary hover:bg-[#1E5F5C] hover:border-[#1E5F5C] focus:bg-[#003A37] focus:border-[#003A37] rounded-[40px] gap-[10px] transition-all duration-300 ease-out h-[32px] w-[32px] lg:h-[40px] lg:w-[40px]`}
              >
                <Image
                  src={Ic_search}
                  alt="search"
