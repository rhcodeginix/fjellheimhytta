  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      >
        ...
        <button
          className={`p-3 lg:px-5 lg:py-4 cursor-pointer flex justify-center border border-primary items-center bg-primary hover:bg-[#1E5F5C] hover:border-[#1E5F5C] focus:bg-[#003A37] focus:border-[#003A37] rounded-[40px] transition-all duration-300 ease-out h-[40px] lg:h-[56px] m-4 gap-2 ${
