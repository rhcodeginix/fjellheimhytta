...
const beløpProperties = [
  {
    id: 1,
    title: "Almgård",
    location: "Sokkabekkveien 77 (Asker)",
    ...
    bedrooms: 5,
    bathrooms: 3,
    priceHouse: "8.300.000 NOK",
    priceLand: "2.800.000 NOK",
    totalPrice: "11.100.000 NOK",
  },
  {
    id: 2,
    title: "Almgård",
        ...
        <>
          <SideSpaceContainer>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {beløpProperties.map((property, index) => (
                <div
                  key={index}
                ...
                >
                  <h4 className="text-[#111322] text-sm md:text-base lg:text-lg lg:leading-[30px] mb-2">
                    <span className="font-bold">{property.title}</span> bygget i{" "}
