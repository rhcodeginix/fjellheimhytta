              ...
              <Form>
                <div className="flex gap-6 justify-between">
                  ...
                  <div>
                    <Button
                      text="Send inn"
                      className={`border border-primary bg-white text-primary hover:border-[#1E5F5C] hover:text-[#1E5F5C] focus:border-[#003A37] focus:text-[#003A37] sm:text-base rounded-[40px] w-[176px] h-[48px] font-semibold ${!isChecked ? "opacity-50 cursor-not-allowed" : ""}`}
                      type="submit"
                      disabled={!isChecked}
                    />
                  </div>
