            ...
            <div className="pt-[24px] pb-[147px]">
              ...
              <div className="flex gap-[48px] w-full">
                        ...
                        >
                          <div className="flex flex-col gap-4">
                            ...
                            <p className="text-secondary font-medium text-base">
                              ...
                              ringe deg etter å satt seg godt inn i din
                              drømmebolig.{" "}
                              <span className="font-bold">BoligPartner</span>{" "}
                              vil ha tilgang til informasjonen du har lagt igjen
                              her på <span className="font-bold">MinTomt</span>{" "}
                              for at dere får en mest effektiv prosess og for at{" "}
                              <span className="font-bold">BoligPartner</span>{" "}
                              skal forstå dine ønsker.
                            </p>
                            <div>
                ...
                <div className="w-[58%]">
                  <h3 className="text-black text-2xl mb-6">
                    Behov for{" "}
                    <span className="font-semibold">finansiering?</span>
                  </h3>
                  <div
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <h3 className="text-black text-2xl font-medium">
                        Søk byggelån{" "}
                        <span className="font-semibold">(10.608.690 NOK)</span>{" "}
                        hos:
                      </h3>
                      <Image
                        fetchPriority="auto"
              ...
              <div className="my-7">
                <h4 className="text-black text-xl mb-7">
                  Vil du få en <span className="font-bold">forhåndstakst</span>{" "}
                  fra en megler i{" "}
                      ...
                      <Form className="flex flex-col h-full gap-6">
                        <div className="flex gap-6">
                          <div className="flex items-start gap-3 w-1/2">
                            ...
                            />
                            <p className="text-secondary text-base font-medium">
                              Et byggelån krever en forhåndsktakst på
                              prosjektet, ved en høyere{" "}
                              <span className="font-bold">eTakst</span> enn
                              byggekostnad, vil du kunne bruke dette som
                              egenkapital ovenfor banken.
                            </p>
                          </div>
                          <div className="w-1/2">
                            <label className="flex items-center gap-[12px] container">
                              ...
                              <div className="text-secondary text-sm font-medium">
                                ...
                                <span className="font-bold">forhåndstakst</span>{" "}
                                og
                                <span className="font-bold">
